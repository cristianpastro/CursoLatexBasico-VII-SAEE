...
%Esse comando colocar fonte nas Figuras
...
%Curso do aluno. Ex: Engenharia de Computação, Engenharia Elétrica, Química, Letras, etc
\curso{Engenharia Engenheira}

%Coordenação ao qual o trabalho será apresentado. Ex: Coordenação de Engenharia Elétrica - CEE
\coordenacao{Engenharia Engenheira - CEE}

%O título que o aluno irá receber. Ex: Engenheiro Eletricista, Engenheiro de Computação, etc
\tituloDoFormado {Engenheiro das Engenharias}

%Departamento acadêmico ao qual o aluno está vinculado
\departamento {Engenharia Engenheira}
...
\begin{figure}[htbp]
	...
	\captionsetup{width=0.7\linewidth, font=footnotesize, textfont=bf}
	\captionsource{These mosaics of the south pole of Saturn's moon Titan, made from images taken almost one year apart, show changes in dark areas that may be lakes filled by seasonal rains of liquid hydrocarbons}{Adaptado de NASA/JPL/Space Science Institute}
	\label{fig:mosaics}
\end{figure}
...
\begin{table}[h!]
	...
	\caption*{Fonte: \cite{Anderson1977}}
\end{table}
...
\begin{figure}[htbp]
	...
	\captionsetup{width=0.5\linewidth, font=footnotesize, textfont=bf}
	\captionsource{This illustration shows the precession in DI Herculis. The point at which the two stars come closest (periastron) in their mutual orbit advances (precesses) from orbit to orbit. But the amount of precession in DI Her is less than what theory predicted. The illustration is not to scale}{\cite{Grainger1994}}
	\label{fig:orbital}
\end{figure}
...
\begin{figure}[htbp]
	...
	\captionsetup{width=0.5\linewidth, font=footnotesize, textfont=bf}
	\captionsource{This illustration demonstrates how the equatorial bulges of the two stars in DI Herculis are nearly perpendicular to the binary's orbital plane. This unusual configuration explains why DI Her's orbital precession is not in accordance with theoretical predictions}{\cite{Grainger1994} }
...
\bibliography{bibliografias/bibliografia}    % As referencias deste testo estão no arquivo modelotese.bib
